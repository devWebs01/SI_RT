    ...
    <div class="layout-wrapper layout-content-navbar">
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme"
                :class="{ 'layout-menu-collapsed': isMenuCollapsed }">
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item" :class="{ 'active': route().current('profile.edit') }">
            ...
            <div class="layout-page">
                ...
                <nav class="layout-navbar container-fluid navbar navbar-expand-xl navbar-detached align-items-center bg-navbar-theme"
                    ...
                    <div class="layout-menu-toggle navbar-nav align-items-xl-center me-3 me-xl-0 d-xl-none">
                        <a class="nav-item nav-link px-0" href="javascript:void(0)" @click="toggleMenu">
                                        ...
                                        <a class="dropdown-item" href="#">
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-grow-1">
                                                    <span class="fw-semibold d-block">{{ $page.props.auth.user.name
                                                        }}</span>
        ...
        <!-- Overlay -->
        <div class="layout-overlay" :class="{ 'show': isMenuToggled }" @click="toggleMenu" v-show="isMenuToggled"></div>
    </div>
</template>
